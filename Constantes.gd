...
const MARAVILLAS_NATURALES = {
	...
	"Great Barrier Reef": {"terreno": ["COASTAL"], "bioma": ["MARINE"], "yields": {"Food": 2, "Happiness": 2, "Science": 2}},
	"Great Blue Hole": {"terreno": ["COASTAL"], "bioma": ["MARINE"], "yields": {"Science": 2, "Happiness": 4}},
	"Gullfoss": {"terreno": ["FLAT", "ROUGH"], "bioma": ["TUNDRA"], "yields": {"Food": 6}},
	"Hoerikwaggo": {"terreno": ["MOUNTAINOUS"], "bioma": ["GRASSLAND"], "yields": {"Culture": 2, "Food": 4, "Happiness": 2}},
	...
	"Thera": {"terreno": ["COASTAL"], "bioma": ["MARINE"], "yields": {"Happiness": 2, "Culture": 4}},
	"Torres del Paine": {"terreno": ["MOUNTAINOUS"], "bioma": ["TUNDRA"], "yields": {"Food": 2, "Happiness": 4}},
	"Uluru": {"terreno": ["ROUGH"], "bioma": ["DESERT"], "yields": {"Happiness": 6}},
	"Valley of Flowers": {"terreno": ["FLAT"], "bioma": ["PLAINS"], "yields": {"Food": 2, "Culture": 2, "Happiness": 2}},
	"Vihren": {"terreno": ["MOUNTAINOUS"], "bioma": ["PLAINS"], "yields": {"Food": 4, "Production": 2}},
	"Vinicunca": {"terreno": ["MOUNTAINOUS"], "bioma": ["DESERT"], "yields": {"Production": 2, "Science": 2, "Happiness": 2}},
